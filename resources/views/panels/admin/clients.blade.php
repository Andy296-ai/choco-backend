            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $client->telegram_username ? '@'.$client->telegram_username : '-' }}</td>
                        <td>{{ $client->discount }}%</td>
                        <td><a href="#" style="color: var(--gold);">Профиль</a></td>
                    </tr>
                    @empty
                    <tr>
                        <td colspan="5" style="text-align: center;">Клиенты не найдены</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
